...
<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    ...
    <div class="navbar nav_title" style="border: 0;">
      <a href="<?php echo base_url('pegawai'); ?>" class="site_title"><img src="<?php echo base_url(); ?>../assets/images/telkom-property.png" style="width: 70px; height: 47px"></i> <span>Beranda</span></a>
    </div>
        ...
        <ul class="nav side-menu">
          <li><a><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu" style="display: none">
              <li><a href="<?php echo base_url('pegawai'); ?>">Profile</a></li>
              <li><a href="<?php echo base_url('pegawai/log_history'); ?>">Log History</a></li>
            </ul>
          </li>
        </ul>
      </div>
