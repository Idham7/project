        ...
        <ul class="nav side-menu">
          <li><a><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu" style="display: none">
              <li><a href="<?php echo base_url('admin/beranda/'.$myid); ?>">Profile</a></li>
              <li><a href="<?php echo base_url('admin/log_history_admin/'.$myid); ?>">Log History</a></li>
            </ul>
          </li>
        </ul>
      </div>
